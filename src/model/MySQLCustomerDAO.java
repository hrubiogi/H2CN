...
public class MySQLCustomerDAO implements CustomerDAO {
    @Override
    public void saveCustomer(String name, String address, String nif, String email) {
        try (Connection connection = ConnectDB.connect()) {
            if (connection != null) {
                System.out.println("Conexión exitosa");

                // Sentencia SQL para insertar un nuevo Customer
                String sql = "INSERT INTO Customers (name, address, nif, email) VALUES (?, ?, ?, ?)";
